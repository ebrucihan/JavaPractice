...
import Week7.CarRentalProject.dao.BookDao;
import Week7.CarRentalProject.dao.CarDao;
import Week7.CarRentalProject.entity.Book;
import Week7.CarRentalProject.entity.Car;
...
public class CarManager {
    ...
    public boolean update(Car car) {
        if (this.getById(car.getId()) == null) {
            Helper.showMsg(car.getId() + "ID kayıtı araç bulunamadı");
            return false;
        }
